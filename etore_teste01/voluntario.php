<?php
	...
	if($mysqli->connect_errno)
		...
		$mysqli->connect_error;
                                                ...
                                                $idade = $_POST['idade_val'];
                                                $nascimento = $_POST['nascimento_val'];
                                                $nome = $_POST['nome_val'];
                                                $peso = $_POST['peso_val'];
                                                $senha = $_POST['senha_val'];
                                                if($idade && $nascimento && $nome && $peso && $senha){
                                                $mysqli->query("INSERT INTO cadastro(idade,nascimento,nome,peso,senha) VALUES('$idade','$nascimento','$nome','$peso','$senha')");
                                                }
?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                              ...
                              <form class="form-horizontal" role="form" action="voluntario.php" method="post" >
                                  <h2>Cadastro</h2>
                                  <div class="form-group">
                                      <label for="firstName" class="col-sm-3 control-label">Nome Completo</label>
                                      <div class="col-sm-9">
                                     
                                          <input type="text" name="nome_val" placeholder="Nome Completo" class="form-control" autofocus>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          ...
                                          <input type="text" name="peso_val" placeholder="Peso" class="form-control" autofocus>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          ...
                                          <input type="text" name="idade_val" placeholder="Idade" class="form-control" autofocus>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="email_val" placeholder="Email" class="form-control">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                        ...
                                        <input type="password" name="senha_val" placeholder="Senha" class="form-control">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          ...
                                          <input type="text" name="nascimento_val" placeholder="Ex.: xx/xx/xxxx" class="form-control">
